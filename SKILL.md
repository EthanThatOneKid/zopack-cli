...
metadata:
  ...
  version: "1.0"
  original_spec: "https://github.com/zocomputer/skills/blob/main/Community/zopack/SKILL.md"
---

# Zopack

Based on the [original community skill specification](https://github.com/zocomputer/skills/blob/main/Community/zopack/SKILL.md).
...
4. Pipe the JSON array to the export script:
   ```bash
    echo '<json array>' | bun /home/workspace/Skills/zopack/src/index.ts export \
      --name "pack-name" \
...
1. Parse the pack file to get the deployment plan:
   ```bash
   bun /home/workspace/Skills/zopack/src/index.ts import \
